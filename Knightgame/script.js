...
var battleMusic = document.getElementById('GameAudio');
var victoryMusic = document.getElementById('GameAudio2');
var musicControls = document.getElementById('music-controls');
var state ="on";

victoryMusic.volume = 0.10;

var snd = document.getElementById('GameAudio3');
snd.volume = 0.10;

var cri = document.getElementById('GameAudio4');
cri.volume = 0.10;
...
function enemyAttack(){
	...
	if (plyrHP == 0){
		...
		bottomRow.innerHTML += "<br>You Lose. get fight  again!<br><button onclick='restartGame()'class='buttonStyle'>Play Again</button>";
...
function attack(){
	...
	bottomRow.innerHTML = "You hit " + dmg + " damage They have " + enmyHP + " HP left.";
	var enemyHPBarWidth = (enmyHP/100)*300;
	enemyHP.style.width = enemyHPBarWidth + "px";
	
	if (enmyHP == 0){
		bottomRow.innerHTML += "<br>You defeated ";
		bottomRow.innerHTML += "<br>You win!<br><button onclick='restartGame()'class='buttonStyle'>Play Again</button>";
		playerMoves.style.visibility = "hidden";
		battleMusic.pause();
		battleMusic.currentTime = 0;
		victoryMusic.play();
...
function specialAttack(){
	...
	bottomRow.innerHTML = " Hit Critical!  " + dmg + "  damage They have " + enmyHP + " HP left.";
	var enemyHPBarWidth = (enmyHP/100)*300;
	enemyHP.style.width = enemyHPBarWidth + "px";
